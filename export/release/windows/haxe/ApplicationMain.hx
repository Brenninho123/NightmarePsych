...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NightmarePsych", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("NightmarePsych", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "141";
		app.meta["company"] = "Brenninho";
		app.meta["file"] = "NightmarePsych";
		app.meta["name"] = "NightmarePsych";
		app.meta["packageName"] = "com.brenninho.nightmarepsychengine";
		...
		#elseif air
		app.window.title = "NightmarePsych";
		#else
